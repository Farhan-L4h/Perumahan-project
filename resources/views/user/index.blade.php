...
<body>
  ...
  <div class="hero">
    <div class="hero-slide">
      <div
        class="img overlay"
        style="background-image: url('{{ asset('images/hero_bg_3.jpg') }}')"></div>
      <div
        class="img overlay"
        style="background-image: url('{{ asset('images/hero_bg_2.jpg') }}')"></div>
      <div
        class="img overlay"
        style="background-image: url('{{ asset('images/hero_bg_1.jpg') }}')"></div>
    </div>
          ...
          <div class="property-slider-wrap">
            <div class="property-slider">
              ...
              <div class="property-item">
                <a href="/user/property-single/{{$data->properties_id}}" class="img">
                  <img src="{{ asset('storage/properties/'.$data->image) }}" alt="Image" class="img-fluid" />
                </a>

                <div class="property-content">
                  <div class="price mb-2"><span>{{$data->harga}}</span></div>
                  <div>
                    <span class="d-block mb-2 text-black-50">{{$data->nama}}</span>
                    <span class="city d-block mb-3">{{$data->alamat}}, {{$data->kota}}</span>
