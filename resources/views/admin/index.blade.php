...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('admin-once/src/tailwind-favicons/apple-touch-icon.png') }}"/>
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('admin-once/src/tailwind-favicons/favicon-32x32.png') }}"/>
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('admin-once/src/tailwind-favicons/favicon-16x16.png') }}"/>
  <link rel="mask-icon" href="{{ asset('admin-once/src/tailwind-favicons/safari-pinned-tab.svg') }}" color="#00b4b6"/>
      ...
      <div class="navbar-item dropdown has-divider has-user-avatar">
        <a class="navbar-link">
          <div class="user-avatar">
            <img src="{{ asset('https://avatars.dicebear.com/v2/initials/john-doe.svg') }}" alt="John Doe" class="rounded-full">
          </div>
